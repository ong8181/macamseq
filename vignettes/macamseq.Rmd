---
title: "macamseq: A subset of the R package macam for DNA sequence analysis"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{macamseq: A subset of the R package macam for DNA sequence analysis}
...
```{r, eval=FALSE}
library(macamseq)
packageVersion("macamseq")
browseVignettes("macamseq")
```
